...
if (!function_exists('getNumberOfReview')) {
    ...
    {
        return count(\App\Models\UserRating::where('freelancer_id', Auth::user()->id)->get());
    }
}
...
if (!function_exists('isClient')) {
    function isClient()
    {
        return Auth::user()->duty == "Client" ? 1 : 0;
    }
}
...
if (!function_exists('isFreelancer')) {
    ...
    {
        return Auth::user()->duty == "Freelancer" ? 1 : 0;
    }
}
