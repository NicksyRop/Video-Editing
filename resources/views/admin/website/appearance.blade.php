				...
				<form action="{{ route('general-config.store') }}" method="POST">
					...
					<div class="form-group">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="file" class="form-control" name="site_icon" value="{{ get_setting('site_icon') }}" class="selected-files">
						</div>
				...
				<form action="{{ route('system_configuration.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="file" class="form-control" name="meta_image" value="{{ get_setting('meta_image') }}" class="selected-files">
						</div>
						<div class="file-preview box"></div>
					</div>
					<div class="text-right">
