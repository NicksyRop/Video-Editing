                    ...
                    <form class="form-horizontal" action="{{ route('general-config.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                <input type="file" class="form-control" name="system_logo_white" value="{{ get_setting('system_logo_white') }}" class="selected-files">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="file" class="form-control" name="system_logo_black" value="{{ get_setting('system_logo_black') }}" class="selected-files">
                            </div>
                            <div class="file-preview box sm"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                <input type="file" class="form-control" name="admin_login_background" value="{{\App\Utility\SettingsUtility::get_settings_value('admin_login_background')}}" class="selected-files">
                            </div>
                            <div class="file-preview box sm"></div>
                        </div>
