<section class="py-5">
    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        ...
        <div class="text-center mb-3 px-3">
            <button class="btn btn-block btn-soft-primary" target="_blank">{{ App\Models\Level::where('id',Auth::user()->profile->level_id)->first()->level}}</button>
        </div>
            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Withdraw History</span>
                            </a>
                        </li>
                                ...
                                <li class="aiz-side-nav-item">
                    <a href="https://ediyt.com/following-clients" class="aiz-side-nav-link">
                        <i class="las la-tachometer-alt aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">Following Clients</span>
                    </a>
                </li>
                                                <li class="aiz-side-nav-item">
                    <a href="https://ediyt.com/chat" class="aiz-side-nav-link ">
                        <i class="las la-tachometer-alt aiz-side-nav-icon"></i>
               ...
               <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="https://ediyt.com/account-settings" class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">Account Setting</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="https://ediyt.com/profile-settings" class="aiz-side-nav-link ">
